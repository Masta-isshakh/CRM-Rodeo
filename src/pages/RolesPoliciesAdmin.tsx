  ...
  },
{
...

  {
    ...
    options: [
      ...
      { id: "filesharing_folder_create", label: "Create folders", prefix: "c." },
      { id: "filesharing_move", label: "Move files/folders", prefix: "d." },
      { id: "filesharing_star", label: "Star files", prefix: "e." },
      { id: "filesharing_share", label: "Share / change visibility", prefix: "f." },
      { id: "filesharing_share_link_create", label: "Create expiring shared links", prefix: "g." },
      { id: "filesharing_share_link_revoke", label: "Revoke shared links", prefix: "h." },
      { id: "filesharing_download", label: "Download files", prefix: "i." },
      { id: "filesharing_version_view", label: "View version history", prefix: "j." },
      { id: "filesharing_version_restore", label: "Restore old versions", prefix: "k." },
      { id: "filesharing_soft_delete", label: "Move to trash (soft delete)", prefix: "l." },
      { id: "filesharing_restore", label: "Restore from trash", prefix: "m." },
      { id: "filesharing_delete_own", label: "Delete own files", prefix: "n." },
      { id: "filesharing_delete_any", label: "Delete any file", prefix: "o." },
      { id: "filesharing_hard_delete", label: "Permanent delete", prefix: "p." },
      { id: "filesharing_manage_all", label: "Manage all files", prefix: "q." },
      { id: "filesharing_admin_panel", label: "Open drive admin panel", prefix: "r." },
      { id: "filesharing_quota_manage", label: "Manage user storage quotas", prefix: "s." },
      { id: "filesharing_view_analytics", label: "View storage analytics", prefix: "t." },
      { id: "filesharing_cross_department", label: "Cross-department sharing", prefix: "u." },
    ],
  },
  {
                ...
                <div className="rac-current-role">
                  <span className="rac-current-role-icon" aria-hidden>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                      ...
                      <path d="M8.5 16c.9-1.4 2.1-2 3.5-2s2.6.6 3.5 2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
                    </svg>
                  </span>
