import { AdminGetUserCommand, AdminListGroupsForUserCommand, CognitoIdentityProviderClient, ListUsersCommand, } from "@aws-sdk/client-cognito-identity-provider";
...
async function ensureUserProfileByEmail(dataClient, userPoolId, email) {
...
export const handler = async (event) => {
    ...
    const dashboardAccessEnabled = typeof event.arguments?.dashboardAccessEnabled === "boolean"
        ? Boolean(event.arguments.dashboardAccessEnabled)
        : Boolean(profile?.dashboardAccessEnabled ?? true);
