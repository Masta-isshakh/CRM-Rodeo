import { CognitoIdentityProviderClient, CreateGroupCommand, GetGroupCommand, } from "@aws-sdk/client-cognito-identity-provider";
...
export const handler = async (event) => {
    ...
    if (!allowed)
        throw new Error("Not authorized to create departments. Check roles and policies configuration.");
