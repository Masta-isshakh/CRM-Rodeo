...
const myGroupsFn = backend.myGroups.resources.lambda;
myGroupsFn.addToRolePolicy(new PolicyStatement({
...
const adminCognitoFn = backend.adminCognito.resources.lambda;
adminCognitoFn.addToRolePolicy(new PolicyStatement({
    actions: [
...
const processSmsDeliveryStatusFn = backend.processSmsDeliveryStatus.resources.lambda;
const resolveDriveShareLinkFn = backend.resolveDriveShareLink.resources.lambda;
const driveRetentionCleanupFn = backend.driveRetentionCleanup.resources.lambda;
